...
import 'auth/signup.dart';  // ✅ make sure class inside is named Signup or SignupScreen
...
class _OnboardingPage1State extends State<OnboardingPage1>
  ...
  void initState() {
    ...
    final screenWidth = MediaQueryData.fromView(View.of(context)).size.width; // ✅ new API
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ✅ Removed `width:` since ModernButton doesn’t support it
                    ModernButton(
                      text: 'Get Started',
                      onPressed: () {
                        Navigator.push(
                          context,
                          PageRouteBuilder(
                            pageBuilder: (_, __, ___) => const OnboardingPage2(),
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (_) => SignupScreen()), // ✅ use correct class name
                  );
                },
                child: const Text(
                  'Skip',
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              color: Colors.white.withOpacity(active ? 1.0 : 0.4), // still safe
            ),
          ),
          Container(
            width: 6,
