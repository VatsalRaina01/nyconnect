...
class HomeAdvocateScreen extends StatefulWidget {
  final String userName;

  const HomeAdvocateScreen({super.key, required this.userName});

  @override
  State<HomeAdvocateScreen> createState() => _HomeAdvocateScreenState();
}

class _HomeAdvocateScreenState extends State<HomeAdvocateScreen> {
  int _currentIndex = 0;
